...
def extract_faces(input_folder, output_folder):
    ...
    print("Total faces saved:", count-1)
...
def main():
    ...
    original_input = "data/processed/original"
    original_output = "data/faces/original"

    deepfake_input = "data/processed/deepfakes"
    deepfake_output = "data/faces/deepfakes"
